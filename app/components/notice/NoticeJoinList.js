...
class NoticeJoinList extends Component {
    static propTypes = {
        ...
        if (/sreceivers/g.test(location.pathname)) {
            ...
            if (id) {
              ...
              //  getNoticeComments(id, {pageSize: paginationSetting.pageSize});
                getNoticeJoin(id, {pageSize: paginationSetting.pageSize});
            }
        }
    }
    ...
    handelPageChange = (page, pageSize) => {
        ...
        getNoticeJoin(this.id, Object.assign({pageSize, page}));
    };
